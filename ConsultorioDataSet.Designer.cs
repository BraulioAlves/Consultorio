...
namespace Consultorio.ConsultorioDataSetTableAdapters {
    ...
    public partial class ConsultasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Consultas] WHERE (([ID_Consulta] = @Original_ID_Consulta) AND ([Nome" +
                "_Paciente] = @Original_Nome_Paciente) AND ([Nome_Medico] = @Original_Nome_Medico" +
                ") AND ([Data] = @Original_Data) AND ([Horario] = @Original_Horario))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Consultas] ([Nome_Paciente], [Nome_Medico], [Data], [Horario]) VALUES (@Nome_Paciente, @Nome_Medico, @Data, @Horario);
SELECT ID_Consulta, Nome_Paciente, Nome_Medico, Data, Horario FROM Consultas WHERE (ID_Consulta = SCOPE_IDENTITY()) ORDER BY Data";
...
SELECT ID_Consulta, Nome_Paciente, Nome_Medico, Data, Horario FROM Consultas WHERE (ID_Consulta = @ID_Consulta) ORDER BY Data";
